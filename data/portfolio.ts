...
export const WORKS: Work[] = [
...

  {
    ...
    // desc: "一般従業員・管理者を想定し、勤怠打刻・複数休憩・勤怠修正申請・承認管理・スタッフ管理までを、一元管理できるシステムとして開発しました。\nLaravelをバックエンドとし、Next.jsによるSPA化を段階的に進めてる勤怠管理システムです。",
    desc: "一般従業員・管理者を想定し、勤怠打刻・複数休憩・勤怠修正申請・承認・スタッフ管理までを一元管理できる勤怠管理システムとして開発しました。\nLaravelをバックエンドとし、現在はログイン機能などからNext.jsへの段階的なSPA化を進めています。",
...
export const TIMELINE = [
...

  {
    ...
    detail:
      "製造業を退職し、ハローワークのIT実践訓練校を通じてWeb開発を学び始めました。AIの時代に入ったことで確実に案件を獲得したいと、更に上部レベルのエンジニア実践型スクールにて模擬案件に参加。Laravel / PHP / MySQL / Docker / Git・GitHub / React / Next.js / TypeScript などを用いて複数のWebアプリケーションを開発。テストコード作成やAWSを利用した公開作業にも取り組み、実務を意識した開発経験を積み重ねています。",
  },
];
